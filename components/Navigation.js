    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`flex justify-between items-center transition-all duration-700 h-20`}>
            {/* Logo */}
              ...
              >
                <div className="px-6 py-6 space-y-4">
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-purple-500 to-cyan-400 text-white shadow-[0_0_15px_rgba(0,255,255,0.6)] rounded-full"
                  >
                    Get Started
                  </Button>
                </div>
